...
from app.models import email_verification_token, password_reset_token, permission, rbac, refresh_token, role, tenant, tenant_invitation, tenant_member, user  # noqa: F401
